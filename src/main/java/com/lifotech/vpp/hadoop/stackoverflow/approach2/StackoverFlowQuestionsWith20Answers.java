...
public class StackoverFlowQuestionsWith20Answers extends Configured implements Tool {

    private static final Logger logger = LoggerFactory.getLogger(StackoverFlowQuestionsWith20Answers.class);
    ...
    public int run(String[] args) throws Exception {
        ...
        // job set jar
        job.setJarByClass(StackoverFlowQuestionsWith20Answers.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            int jobStatus = ToolRunner.run(new Configuration(), new StackoverFlowQuestionsWith20Answers(), args);
